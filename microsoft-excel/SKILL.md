# Microsoft Excel (Bridged from ClawHub)
...
> Original Docs: https://clawhub.ai/byungkyu/microsoft-excel

```yaml
id: "microsoft-excel"
version: "1.0.0"
agent_summary: "Microsoft Excel API integration with managed OAuth. Read and write Excel workbooks, worksheets,..."
cost_per_call: 0
