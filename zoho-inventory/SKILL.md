# Zoho Inventory (Bridged from ClawHub)
...
> Original Docs: https://clawhub.ai/byungkyu/zoho-inventory

```yaml
id: "zoho-inventory"
version: "1.0.0"
agent_summary: "Zoho Inventory API integration with managed OAuth. Manage items, sales orders, invoices, purcha..."
cost_per_call: 0
