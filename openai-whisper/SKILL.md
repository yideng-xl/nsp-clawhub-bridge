# Openai Whisper (Bridged from ClawHub)
...
> Original Docs: https://clawhub.ai/steipete/openai-whisper

```yaml
id: "openai-whisper"
version: "1.0.0"
agent_summary: "Local speech-to-text with the Whisper CLI (no API key)."
cost_per_call: 0
