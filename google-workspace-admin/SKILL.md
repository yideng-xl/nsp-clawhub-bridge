# Google Workspace Admin (Bridged from ClawHub)
...
> Original Docs: https://clawhub.ai/byungkyu/google-workspace-admin

```yaml
id: "google-workspace-admin"
version: "1.0.0"
agent_summary: "Google Workspace Admin SDK integration with managed OAuth. Manage users, groups, organizational..."
cost_per_call: 0
