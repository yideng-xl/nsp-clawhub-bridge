# Spotify Player (Bridged from ClawHub)
...
> Original Docs: https://clawhub.ai/steipete/spotify-player

```yaml
id: "spotify-player"
version: "1.0.0"
agent_summary: "Terminal Spotify playback/search via spogo (preferred) or spotify_player."
cost_per_call: 0
