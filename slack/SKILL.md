...
> Original Docs: https://clawhub.ai/steipete/slack

```yaml
id: "slack"
version: "1.0.0"
agent_summary: "Use when you need to control Slack from Clawdbot via the slack tool, including reacting to mess..."
cost_per_call: 0
