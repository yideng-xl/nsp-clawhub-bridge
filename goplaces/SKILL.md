...
> Original Docs: https://clawhub.ai/steipete/goplaces

```yaml
id: "goplaces"
version: "1.0.0"
agent_summary: "Query Google Places API (New) via the goplaces CLI for text search, place details, resolve, and..."
cost_per_call: 0
